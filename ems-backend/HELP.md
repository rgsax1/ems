...
* The original package name 'rodrigo.salles.ems-backend' is invalid and this project uses 'rodrigo.salles.emsbackend' instead.
...
```
$ docker run --rm -p 8080:8080 ems-backend:0.0.1-SNAPSHOT
```
